...
@WebServlet(name = "ReporteProductosServlet", urlPatterns = {"/ReporteProductos"})
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String fpath = request.getServletContext().getRealPath("")
                    + "\\WEB-INF\\reportes\\reporteProductos.jrxml";
            ...
            List<ReporteProductos> reporte = DaoFactory.getInstancia().getDaoReporteProductos().reporte(idVendedor);
            Iterator<ReporteProductos> it= reporte.iterator();
            while (it.hasNext()){ReporteProductos rp=it.next(); rp.setImagen(rp.getImagen().startsWith("http")?rp.getImagen():base+rp.getImagen());}
